...
public class IntakeController {
  ...
  private final InterfaceIntakeService<IntakeResponse, IntakeRequest> service;

  public IntakeController(InterfaceIntakeService<IntakeResponse, IntakeRequest> service) {
